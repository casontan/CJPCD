...
/**
  ...
  * 3.调用方法
  	...
  	如下:
  	1)初始化:(provinceId:省份ID,cityId:城市ID,districtId:区ID) 		  
      var pcd = new CJPCD("provinceId","cityId","districtId");

 		2)设置自定义值
 			1.在初始化的前提下调用
 			pcd.setUp(province,city,district);
 	  ...
 	  4)获取值
 	  	...
 	  	注意不指定分割字符,返回的是json对象,如果未选择地址则返回 null
 	  	正常返回如下:
 	  	{"province":province_val,"city":city_val,"district":district_val}
